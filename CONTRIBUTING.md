...
You want to contribute to pony-lisp? Awesome.
...
First of all please [search existing issues](https://github.com/stereobooster/pony-lisp/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/stereobooster/pony-lisp/issues/new).
